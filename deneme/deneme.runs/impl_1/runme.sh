...
HD_PWD='C:/Users/ilkay/Desktop/fpga/deneme/deneme.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log sys1.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source sys1.tcl -notrace
