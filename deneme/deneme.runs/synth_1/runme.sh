...
HD_PWD='C:/Users/ilkay/Desktop/fpga/deneme/deneme.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log sys1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source sys1.tcl
