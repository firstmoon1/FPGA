...
module main(
 ...
 // position registers    
  position_detec position_reg_unit(
 ...
 // winner detector 
 winner_1 win_detect_unit(pos1,pos2,pos3,pos4,pos5,pos6,pos7,pos8,pos9,win,who);
 // position decoder for computer 
 position pd1(computer_position,computer_play,PC_en);
 // position decoder for player  
 position pd2(player_position,player_play,PL_en); 
 // illegal move detector
  illegal_move imd_unit(
 ...
 controller tic_tac_toe_controller(
