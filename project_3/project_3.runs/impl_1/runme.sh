...
HD_PWD='C:/Users/ilkay/Desktop/fpga/project_3/project_3.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log source1.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source source1.tcl -notrace
