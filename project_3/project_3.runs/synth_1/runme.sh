...
HD_PWD='C:/Users/ilkay/Desktop/fpga/project_3/project_3.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log source1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source source1.tcl
