...
HD_PWD='C:/Users/ilkay/Desktop/fpga/project_8/project_8.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log freq_divider.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source freq_divider.tcl -notrace
