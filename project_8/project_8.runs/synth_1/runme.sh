...
HD_PWD='C:/Users/ilkay/Desktop/fpga/project_8/project_8.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log freq_divider.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source freq_divider.tcl
